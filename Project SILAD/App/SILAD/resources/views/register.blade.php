          ...
          <div class="lg:col-span-2">
            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
              ...
              <div class="md:col-span-5">
                ...
                <input type="text" name="idp" id="idp" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="" />
              </div>
              ...
              <div class="md:col-span-5 text-right">
              <li>
              <a href="/" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-3 rounded">Kembali</a>
                        </li>
              </div>
