...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <h1 class="text-3xl text-black pb-2 py-4">Daftar Surat Selesai</h1>
            <div class="w-1/2"></div>
    ...
    <tbody class="bg-white divide-y divide-gray-200">
        <tr>
            ...
            <button class="px-4 py-2 font-medium text-white bg-blue-600 rounded-md hover:bg-blue-500 focus:outline-none focus:shadow-outline-blue active:bg-blue-600 transition duration-150 ease-in-out">Cetak</button>
            </a>
        </tr>
        <tr>
            <td class="px-6 py-4 whitespace-nowrap">AJ002</td>
