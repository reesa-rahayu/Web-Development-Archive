...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <aside class="relative bg-sidebar h-screen w-64 hidden sm:block shadow-xl">
        ...
        <nav class="text-white text-base font-semibold pt-0">
            ...
            <a href="{{ url('/kelolauser') }}" class="flex items-center active-nav-link text-white opacity-75 hover:opacity-100 py-4 pl-6 nav-item">
    ...
    <div class="w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <h1 class="text-3xl text-black pb-2 py-4">Kelola User</h1>
            <div class="w-1/2"></div>
