<x-app-layout>
    ...
    <div class="bg-gray-100 font-family-karla flex justify-center overflow-y-scroll">
        <div class="bg-white border-4 rounded-lg shadow relative m-5 w-3/4">
                ...
                <form action="https://formbold.com/s/FORM_ID" method="POST">
                    ...
                    <div class="-mx-3 flex flex-wrap">
                        ...
                        <div class="w-full px-3 sm:w-1/2">
                            <div class="mb-5">
                                ...
                                <input type="date" name="tanggallahir" id="tanggallahir" placeholder=""
                                    min="0"
                                    class="w-full appearance-none rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                            </div>
                        </div>
                    ...
                    <div class="-mx-3 flex flex-wrap">
                        ...
                        <div class="w-full px-3 sm:w-1/2">
                            <div class="mb-5">
                                <label for="agama"
                                    class="mb-2 block text-base font-medium text-[#07074D]">Agama</label>
                                <select id="agama"
