...
<body class="bg-gray-100 font-family-karla flex overflow-y-scroll">
    ...
    <h2 class="text-2xl text-black py-4 px-4 pb-2 center">Formulir Surat Keterangan Domisili</h2>
    ...
    <div class="w-full px-3 sm:w-1/2">
      <div class="mb-5">
        ...
        <div class="w-full px-3 sm:w-1/2">
            <div class="mb-5">
            <label for="agama"  class="mb-2 block text-base font-medium text-[#07074D]">Agama</label>
            <select id="agama" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-4 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
    ...
    <div class="-mx-3 flex px-3 flex-wrap w-full">
        ...
        <div class="mb-5">
                      ...
                      <div class="flex space-x-2">
                  <div class="flex">
                      <input type="radio" name="radio3" id="radioButton3" class="h-5 w-5"/>
                      <label for="radioButton3" class="pl-3 text-base font-medium text-[#07074D]">
                      Belum Kawin
                      </label>
                  </div>
                  <div class="flex space-x-2">
                      <input type="radio" name="radio4" id="radioButton4" class="h-5 w-5"/>
                      <label for="radioButton4"cclass="pl-3 text-base font-medium text-[#07074D]">
                      Sudah Kawin
                      </label>
                  </div>
            </div>
        ...
        <div class="mb-5 px-6">
            ...
            <input type="text" name="fwork" id="fwork" placeholder="Pekerjaan"
