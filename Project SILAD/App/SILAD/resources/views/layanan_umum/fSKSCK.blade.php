...
<div class="mb-5">
  ...
  <div class="flex items-start mb-5">
    ...
    <label for="terms" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Saya adalah penduduk Desa Jatiwates yang berdomisili di alamat diatas serta menerangkan bahwa saya berkelakuan baik, tidak pernah minum-minuman keras,tidak pernah mengisap madat juga belum tersangkut perkara polisi. Surat keterangan ini diberikan untuk memenuhi salah satu persyaratan : Pembuatan Surat Keterangan Catatan Kepolisian.</a></label>
  </div>
</body>
</html>