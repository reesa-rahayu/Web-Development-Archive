...
<body>
    <div class="p-6 m-4 bg-white flex justify-center shadow-lg rounded">
        <form method="POST" action="{{ route('fsku-submit') }}" class="max-w-sm mx-auto m-4">
            @csrf
            <div class="mb-5">
            ...
            <div class="mb-5">
                <label for="nama_usaha" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Nama Tempat
                    Usaha</label>
                <input type="text" id="nama_usaha"
                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                    placeholder="" required />
            </div>
            <div class="mb-5">
            ...
            <div class="mb-5">
                <label for="no_ktp" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Nomor
                    KTP</label>
            ...
            <div class="flex items-start mb-5">
                ...
                <label for="terms" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Informasi yang
                    saya
                    berikan benar adanya dan tidak dibuat-buat</a></label>
            </div>
            <button type="submit"
